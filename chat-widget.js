...
(function() {
    ...
    const welcomeScreenHTML = `
        ...
        <div class="user-registration">
            <h2 class="registration-title">الرجاء إدخال التفاصيل الخاصة بك لبدء الدردشة
 ...
 = `chat-launcher ${settings.style.position === 'left' ? 'left-side' : 'right-side'}`;
